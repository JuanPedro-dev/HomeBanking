--
--INSERT INTO client (first_name, last_name, email) VALUES ('Melba', 'Morel', 'melba@mindhub1.com');
...
--
---- Modulo 5 (Card tarjetas) NOOOOO Olvidar comillas simples y los ;
--
--INSERT INTO card (card_holder,card_type,type_color,number,cvv,from_date,thru_date,client_id) VALUES ('Melba Morel',0,0,'3325-6745-7876-4445',990,'2022-09-08','2027-09-08',1L);
--INSERT INTO card (card_holder,card_type,type_color,number,cvv,from_date,thru_date,client_id) VALUES ('Melba Morel',1,2,'2234-6745-552-7888',750,'2022-09-08','2027-09-08',1L);
--INSERT INTO card (card_holder,card_type,type_color,number,cvv,from_date,thru_date,client_id) VALUES ('Irene Saenz',1,1,'5551-222-5343-5390',751,'2022-09-08','2027-09-08',1L);